...
def find_all_roads_within(commuterName, currentLength, maxLength, coveredRoads):#, previousCommuterName):
    ...
    for i in range(len(roadNames)):
        ...
        for intersection in intersections2:
            ...
            #         print "showonmap1-L on ",
            #         print intersecton[0]
            #         lastLength = maxLength - intersection[num-1][3]
            #         print "length : ",
            #         print lastLength
            #         lastCommuterName = str(intersection[1]) + "-L"
            #         copy_commuter(str(intersection[1]), lastCommuterName)        
            ...
            #     else:
            #         print "showonmap1-LL"
            #         lastLength = maxLength - intersections1[num-1][3]
            #         print "length : ",
            #         print lastLength
            #         lastCommuterName = str(intersections1[num-1][1]) + "-LL"
            #         copy_commuter(str(intersections1[num-1][1]), lastCommuterName)        
            #         # turn_to(lastCommuterName, str(intersections1[num-1][0]))
            #         move_distance(lastCommuterName, lastLength)
            #         show_on_map(lastCommuterName)
        ...
        # for intersection in intersections2:
        #     num += 1
        #     if num < len(intersections2):
        #         find_all_roads_within(intersection[1], intersection[3], maxLength, newCoveredRoads)#, intersection[2])
        #     else:
        #         # find_all_roads_within(intersection[1], intersection[3], maxLength, newCoveredRoads)
        #         if num == 1:
        #             print "showonmap1-L"
        #             lastLength = maxLength - intersections2[num-1][3]
        #             print "length : ",
        #             print lastLength
        #             lastCommuterName = str(intersection[1]) + "-L"
        #             copy_commuter(str(intersection[1]), lastCommuterName)        
        ...
        #             print "length : ",
        #             print lastLength
        #             lastCommuterName = str(intersections2[num-1][1]) + "-LL"
        #             copy_commuter(str(intersections2[num-1][1]), lastCommuterName)        
        #             # turn_to(lastCommuterName, str(intersections2[num-1][0]))
        #             move_distance(lastCommuterName, lastLength)
        #             show_on_map(lastCommuterName)
