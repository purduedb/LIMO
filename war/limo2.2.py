...
def find_all_roads_within(commuterName, currentLength, maxLength, coveredRoads):#, previousCommuterName):
    ...
    for i in range(len(roadNames)):
        ...
        if nextPoint[3][0] != 0.0:
            ...
            while stop == False:
                ...
                if nextBearings[0] == 0.0: # end of road
                    ...
                    move_next_intersection(newName)
                    # nextBearings = turn_to(newName, roadNames[i])
        ...
        for intersection in intersections1:
            if float(intersection[3]) < maxLength:
                find_all_roads_within(intersection[1], intersection[3], maxLength, newCoveredRoads)#, intersection[2])
            else:
                print "showonmapIntersection1"
                print "maxLength : " ,
                print maxLength 
                print "beforeLength : ",
                print display_distance(str(intersection[2]))
                return
                lastLength = maxLength - display_distance(str(intersection[2]))
                
                lastCommuterName = str(intersection[2]) + "-L"
                copy_commuter(str(intersection[2]), lastCommuterName)


                print "lastCommuterName ",
                print lastCommuterName
                print "lastLength",
                print lastLength
        ...
        # if nextPoint[0] == 0:
            # print "came in 0"
#             show_on_map(str(commuterName))
        
        # elif nextPoint[0] == 1:
            # print "came in 1"
#             newName = str(commuterName) + "_" + roadNames[i]
#             copy_commuter(commuterName, newName)
...
#             show_commuter(newName)
#             turn_to(newName, roadNames[i], nextPoint[3][0])
#             print "----------------------"
#             show_commuter(newName)

#             # for i in range(18):
#                 # move_distance(newName, 0.03)

#             found = True
#             iii = 0
#             currentL = currentLength
#             while (1):
#                 print "iter" + str(iii)
#                 iii += 1
#                 if iii > 10:
...
#                 turn_to(newName, roadNames[i])
#                 print "----------------------"
#                 show_commuter(newName)
#                 move_next_intersection(newName)
#                 currentL = display_distance(newName)
#                 # found = move_distance(newName, 0.5)
...
#                 for name in names:
#                     if name not in newCoveredRoads:
#                         intersections.append([name, get_current_point(newName), currentL])
...
#             # find_all_roads_within(commuterName, currentLength, maxLength, coveredRoads)
#             for inter in intersections:
#                 if float(inter[2]) < maxLength:
#                     find_all_roads_within(newName, float(inter[2]), maxLength, newCoveredRoads)
#                 else:
#                     show_on_map(newName)
    ...
    # #             show_commuter(newName)
    #             print "selectedbearing : ",
    #             print turn_to(newName, roadNames[i], nextPoint[3][0])
    #             print "selectedroadNames : ",
    #             print roadNames[i]
    #             # print "return from move next intersection : ",
    #             move_next_intersection(newName)
    #             # show_on_map(newName)

    #             usedLength = display_distance(newName)
    #             print "end 22222222222 - 1"
    #             print "usedLength " + str(usedLength) 

    #             if usedLength < maxLength:
    #                 find_all_roads_within(newName, usedLength, maxLength, newCoveredRoads, str(commuterName))
    #             else:
    #                 print "showmap"
    #                 remainDistance = maxLength - currentLength
    #                 # show_commuter(str(commuterName))
    #                 # print "currentcommutername : ",
    #                 # print newName
    #                 print "=== remainDistance ",
    #                 print remainDistance
    #                 lastName = str(commuterName) + "_" + roadNames[i] + "-L"
    #                 copy_commuter(commuterName, lastName)

    #                 print turn_to(str(lastName), roadNames[i])
    #                 move_distance(str(lastName), remainDistance)
    #                 show_on_map(str(lastName))
    #                 show_commuter(str(lastName))
    ...
    #             print "2222222222222222 - 2"
    # #             show_commuter(newName)
    #             print "selectedbearing : ",
    #             print turn_to(newName, roadNames[i], nextPoint[3][1])
    #             print "selectedroadName : ",
    #             print roadNames[i]
    #             # print "return from move next intersection : ",
    #             move_next_intersection(newName)
    #             # show_on_map(newName)
...
#             print "2222222222222222 - 2"
# #             show_commuter(newName)
#             print "selected bearing : "
#             print turn_to(newName, roadNames[i], nextPoint[3][1])
#             print "return from move next intersection : ",
#             print move_next_intersection(newName)
#             show_on_map(newName)
...
#                 print "----------------------"
#                 show_commuter(newName)
#                 if commuters.get(str(newName))[3] == 0.0:
#                     break
#                 move_next_intersection(newName)
#                 currentL = display_distance(newName)
#                 # found = move_distance(newName, 0.5)
...
#             print "2222222222222222 - 2"
#             show_commuter(newName)
#             turn_to(newName, roadNames[i], nextPoint[3][1])
#             print "----------------------"
#             show_commuter(newName)
...
############################################################################################################
            ...
            # newName = str(commuterName), str(commuterName) + "_" + roadNames[i] + "-2"
            # copy_commuter(commuterName, newName)
            ...
            #     found = move_distance(newName, 0.01)
        ...
        #     copy_commuter(str(commuterName), str(commuterName) + "_" + roadNames[i])
        #     turn_to(str(commuterName) + "_" + roadNames[i], roadNames[i], nextPoint[3][0])
        #     move_next_intersection(str(commuterName) + "_" + roadNames[i])
        #     show_on_map(str(commuterName) + "_" + roadNames[i])
        #     print display_distance(str(commuterName) + "_" + roadNames[i])
        
        # elif nextPoint[0] == 2:
        #     copy_commuter(str(commuterName), str(commuterName) + "_" + roadNames[i] + "-1")
        #     turn_to(str(commuterName) + "_" + roadNames[i] + "-1", roadNames[i], nextPoint[3][0])
        #     move_next_intersection(str(commuterName) + "_" + roadNames[i] + "-1")
        #     show_on_map(str(commuterName) + "_" + roadNames[i] + "-1")
        #     print "display distance",
        #     print display_distance(str(commuterName) + "_" + roadNames[i] + "-1")

        #     copy_commuter(str(commuterName), str(commuterName) + "_" + roadNames[i] + "-2")
        #     turn_to(str(commuterName) + "_" + roadNames[i] + "-2", roadNames[i], nextPoint[3][1])
        #     move_next_intersection(str(commuterName) + "_" + roadNames[i] + "-2")
        #     show_on_map(str(commuterName) + "_" + roadNames[i] + "-2")
        #     print "display distance",
        #     print display_distance(str(commuterName) + "_" + roadNames[i] + "-2")
...
def move_until3(commuterName, street2):
...
def move_next_intersection2(commuterName):
    commuter = commuters.get(str(commuterName))[0]
    currentPoint = commuters.get(str(commuterName))[1]
...
def move_next_intersection(commuterName):
    ...
    while found == False:
        ...
        newRoads = get_road_names(get_current_point(str(commuterName)))
    ...
    if debug:
        ...
        print str(i/0.01)
        print "current POINT",
        print get_current_point(str(commuterName))
        print "next POINT",
        print nextPoint
...
def move_along_street(lon, lat, street, ZIP, bearing, distance):
    ...
    try:
        ...
        #     if abs(bearing - calculate_initial_compass_bearing( (float(lon), float(lat)), (float(nextPoint2[0]), float(nextPoint2[1])))) > 150:
        #         print "no!!"
        #         nextPoint[0] = 5
        #     else:
        #         nextPoint[0] = 1
        ...
        # if nextPoint2 == "":
        #     if abs(bearing - calculate_initial_compass_bearing( (float(lon), float(lat)), (float(nextPoint1[0]), float(nextPoint1[1])))) > 150:
        #         print "no!!"
        #         nextPoint[0] = 5
        #     else:
        #         nextPoint[0] = 1
...
def move_distance2(commuterName, distance, direction=None):
...
def move_distance(commuterName, distance, direction = None):
        ...
        if nextLonLat[3][0] != 0.0:
            pnts = get_sub_road(street, ZIP, get_EWKT(commuter[len(commuter)-1]), get_EWKT(nextLonLat[1]))
        else:
            pnts = get_sub_road(street, ZIP, get_EWKT(commuter[len(commuter)-1]), get_EWKT(nextLonLat[2][1]))
        # print "pntsss"
        # print pnts
        #if street == "Garden St":
